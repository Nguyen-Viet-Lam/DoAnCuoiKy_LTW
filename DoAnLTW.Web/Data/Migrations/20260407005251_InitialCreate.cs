    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ReportDispatchLogs", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ReportDispatchLogs_Users_UserId",
                        column: x => x.UserId,
                        principalTable: "Users",
                        principalColumn: "Id",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_UserPersonalKeywords", x => x.Id);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    AiSuggestedCategoryId = table.Column<int>(type: "int", nullable: true),
                    AiSuggestedLabel = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: true),
                    AiConfidence = table.Column<double>(type: "float", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_BudgetAlerts_Transactions_WalletTransactionId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_BudgetAlerts_WalletTransactionId",
                table: "BudgetAlerts",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Categories_Name_TransactionType_IsDefault",
                table: "Categories",
                columns: new[] { "Name", "TransactionType", "IsDefault" });

            migrationBuilder.CreateIndex(
                name: "IX_EmailOtps_Email_Purpose_IsUsed",
                table: "EmailOtps",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ReportDispatchLogs_UserId_ReportType_PeriodKey",
                table: "ReportDispatchLogs",
                columns: new[] { "UserId", "ReportType", "PeriodKey" },
                unique: true);
